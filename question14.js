...
let guestName = ["Farah", "Asis", "Dildara", "Rasheeda", "Ruqaya", "Saima"];
guestName.forEach((invitedGuest) => { console.log(`Dear ${invitedGuest} you are invited for the dinner tonight`); });
