...
let current_users : string[] = ["Mustafa", "Roma", "Farah", "Naeema", "Saima"];
let new_users : string[] = ["Mustafa", "Kosar", "Mujtaba","Asia", "Farah", "Murtaza" ];

function UserName( current_users : string[], new_users: string[]) {
